...
<header>
    <video src="../video/marvels.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">MARVELS</h1>
        <p>Moce Carol Danvers splatają się ze zdolnościami Kamali Khan i Moniki Rambeau, zmuszając je do współpracy, aby ocalić wszechświat.
    <div class="detale">
    ...
    <div class="btns">
        <a href="https://www.youtube.com/watch?v=07KvbxlmnIk" id="play">Zwiastun <i class="fa-solid fa-play"></i></a>
        <a href="">11:30</a>
        <a href="">15:15</a>
        <a href="">19:00</a>
    </div>
