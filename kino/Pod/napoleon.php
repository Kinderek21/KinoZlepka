...
<header>
    <video src="../video/Napoleonzwias.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">Napoleon</h1>
        <p>Napoleon Bonaparte pnie się po kolejnych szczeblach władzy. Towarzyszy mu przy tym ukochana Józefina.
    <div class="detale">
        <h6>United International Pictures</h6>
    ...
    <div class="btns">
        ...
        <a href="../sale/napoleon1.php">10:30</a>
        <a href="../sale/napoleon2.php">14:50</a>
        <a href="../sale/napoleon3.php">17:10</a>
    </div>
    </div>
    <section>
