...
<header>
    <video src="../video/igrzyska.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">IGRZYSKA ŚMIERCI: BALLADA PTAKÓW I WĘŻY</h1>
        <p>Młody Coriolanus Snow zostaje mentorem trybutki z Dwunastego Dystryktu podczas 10. Głodowych Igrzysk. Od tego momentu losy jego i Lucy Gray Baird nierozerwalnie się splatają.
    <div class="detale">
        <h6>USA</h6>
        <h5 class="gen">Akcja</h5>
        <h4>2023</h4>
        <h3 id="prem"></h3>
    </div>
    <div class="btns">
        <a href="https://www.youtube.com/watch?v=iFEJn_Z3Hhc&t=2s" id="play">Zwiastun <i class="fa-solid fa-play"></i></a>
        <a href="">9:30</a>
        <a href="">12:50</a>
        <a href="">13:10</a>
        <a href="">15:10</a>
