...
<header>
    <video src="../video/noc.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">NOC DZIĘKCZYNIENIA</h1>
        <p>Mieszkańcy miasta Plymouth, kolebki Święta Dziękczynienia, porzucają tradycyjne, rodzinne zgromadzenia, by celebrować kolejne święto – konsumpcyjny Black Friday.
    <div class="detale">
        <h6>USA</h6>
        <h5 class="gen">Horror</h5>
        <h4>2023</h4>
        <h3 id="prem"><span>PREMIERA</span></h3>
    </div>
    <div class="btns">
        <a href="https://www.youtube.com/watch?v=d9E8K405PRM" id="play">Zwiastun <i class="fa-solid fa-play"></i></a>
        <a href="../sale/dziekcz1.php">19:40</a>
        <a href="../sale/dziekcz2.php">22:15</a>
    </div>
    </div>
    <section>
