...
<header>
    <video src="../video/psi.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">PSI PATROL: WIELKI FILM</h1>
        <p>Kiedy w Adventure City rozbije się magiczny meteor,  szczeniaki z Psiego Patrolu zostaną obdarzone supermocami. Dla Skye, najmniejszej członkini zespołu, jej nowe moce są spełnieniem marzeń. Sprawy przybiorą gorszy obrót, gdy wróg piesków- Humdinger, łączy siły z szalonym naukowcem, aby przejąć moce. Los Adventure City wisi na włosku, więc dzielne pieski będą musiały wkroczyć do akcji i powstrzymać złoczyńców, zanim będzie za późno.
    <div class="detale">
        <h6>USA</h6>
        <h5 class="gen">Animowany</h5>
        <h4>2023</h4>
        <h3 id="prem"></h3>
    </div>
    <div class="btns">
        <a href="https://www.youtube.com/watch?v=d9E8K405PRM" id="play">Zwiastun <i class="fa-solid fa-play"></i></a>
        <a href="">10:30</a>
        <a href="">14:50</a>
        <a href="">17:10</a>
    </div>
