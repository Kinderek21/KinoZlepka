...
<header>
    <video src="../video/fnafzwias.mp4" autoplay muted ></video>
    <nav>
        <div class="logo_ul">
    ...
    <div class="kontent">
        <h1 id="tytul">PIĘĆ KOSZMARNYCH NOCY</h1>
        <p>Film opowiada o zakłopotanym ochroniarzu, który rozpoczyna pracę w Freddy Fazbear's Pizza. Szybko zdaje sobie sprawę, że nocna zmiana nie będzie taka łatwa.
    <div class="detale">
        <h6>USA</h6>
    ...
    <div class="btns">
        <a href="https://www.youtube.com/watch?v=tHDtvFWygxA" id="play">Zwiastun <i class="fa-solid fa-play"></i></a>
        <a href="../sale/Fnaf1.php">18:10</a>
        <a href="../sale/Fnaf2.php">21:10</a>
    </div>
    </div>
    <section>
